    ...
    Hi ! My name is Nishant 
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <motion.span
                className="absolute bottom-2 left-0 right-0 h-3 bg-accent/30 -z-0 rounded"
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
          ...
          <motion.p
            ...
            className="text-body-lg md:text-heading-lg text-muted-foreground max-w-2xl mx-auto mb-10"
          >
           
            
            <br className="hidden sm:block" />
            Turning ideas into stunning visual stories and functional digital solutions.
          </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12.5 mt-10"
          >
